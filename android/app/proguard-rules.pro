...
# permission_handler, image_gallery_saver_plus, share_plus, file_picker,
# receive_sharing_intent, shared_preferences, path_provider) ship their own
# consumer-rules.pro, so most keep-rules are handled automatically.
#
